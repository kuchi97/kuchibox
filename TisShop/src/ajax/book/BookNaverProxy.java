...
public class BookNaverProxy {
	...
	{
		String clientId = "SE0PVTS8HwHFNkMhzaPW";	//애플리케이션 클라이언트 아이디값";
        String clientSecret = "dTuIUDXTgv";			//애플리케이션 클라이언트 시크릿값";
        
        try {
            String text = URLEncoder.encode(key, "UTF-8");
            String apiURL = "https://openapi.naver.com/v1/search/book.json?query="+ text +"&display="+pageSize+"&start="+start; // json 결과
